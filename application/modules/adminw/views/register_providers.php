<?php
  ...
  $funcUrl = admin_url('users/provider');
  $addDataUrl = admin_url('users/add-provider');
  $editDataUrl = admin_url('users/edit-provider');
                                ...
                                <table class="table table-striped table-bordered" style="width:100%">
                                  ...
                                  <tbody id="_data_rows">
                                    ...
                                    <tr>
                                      ...
                                      <td><?=toDate($pageData[$i]['tRegistrationDate'])?></td>
                                      <td><?=$pageData[$i]['vName']?></td>
                                      <td><?=$pageData[$i]['vEmail']?></td>
                                      <td><?=$pageData[$i]['vPhone']?></td>
                                      <td>
                                        <span><i class="fa fa-inr"></i> <?=$pageData[$i]['walletBalance']?></span> /-
                                      </td>
                                      <td><?=$status?></td>
                                      <td>

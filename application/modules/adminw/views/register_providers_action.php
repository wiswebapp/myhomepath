            ...
            <div class="row">
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                  <div class="page-header">
                      ...
                      <div class="page-header">
                          <h1><?=$pageTitle?>
                          <a href="<?=$methodUrl?>provider" class="btn btn-default" style="float: right;"> Back to listing</a>
                          </h1><hr>
                      </div>
                  </div>
              </div>
              ...
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <div class="card-body">
                      ...
                      <form action="<?=$methodUrl.strtolower($action).'-provider/'.$userData['iAgentId']?>" enctype="multipart/form-data" method="post" accept-charset="utf-8" id="regform">
                        ...
                        <div class="form-group col-xl-7 col-lg-7 col-md-7 col-sm-12 col-12">
                          ...
                          <a href="<?=$methodUrl?>provider" type="submit" class="btn btn-sm btn-light">Cancel</a>
                        </div>
                      </form> 

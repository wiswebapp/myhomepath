<?php
  ...
  $table = "organization";
  $pageTitle = "Register Provider";
  $methodUrl = admin_url('users/');
  $funcUrl = admin_url('users/organization');
  $addDataUrl = admin_url('users/add-organization');
  $editDataUrl = admin_url('users/edit-organization');
                      ...
                      <div class="filter-data-box">
                        <form action="" method="GET" id="_filter_data">
                          <table width="100%" cellpadding="1" border="0">
                            <tr>
                              <th>Filter by : </th>
                              <th><input class="form-control" type="text" name="name" placeholder="Salon Name" value="<?=trim($_GET['name'])?>"></th>
                                ...
                                <table class="table table-striped table-bordered" style="width:100%">
                                  ...
                                  <tbody id="_data_rows">
                                    ...
                                    <tr>
                                      ...
                                      <td><?=toDate($pageData[$i]['tRegDateTime'])?></td>
                                      <td><?=$pageData[$i]['vUserName']?></td>
                                      <td><?=$pageData[$i]['vUserEmail']?></td>
                                      <td><?=$pageData[$i]['vUserMobile']?></td>
                                      <td><?=limitCharacter($pageData[$i]['vAddress'])?></td>
                                      <td><?=$status?></td>
                                      <td>

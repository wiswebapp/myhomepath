...
class Recaptcha
{
    ...
    public function __construct()
    {
        ...
        $GOOGLE_RECAPCHA_SITE_KEY = $this->_ci->__getConfiguration('GOOGLE_RECAPCHA_SITE_KEY');
        $GOOGLE_RECAPCHA_SECRET_KEY = $this->_ci->__getConfiguration('GOOGLE_RECAPCHA_SECRET_KEY');
        $GOOGLE_RECAPCHA_LANGUAGE = "en";
        
        $this->_siteKey = $GOOGLE_RECAPCHA_SITE_KEY;
        $this->_secretKey = $GOOGLE_RECAPCHA_SECRET_KEY;
        $this->_language = $GOOGLE_RECAPCHA_LANGUAGE;
